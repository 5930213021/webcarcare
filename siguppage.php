    ...
    <form action='sigup.php' method='post' id="mainform" name='form' enctype="multipart/form-data">
        <div class="container" style="margin-top :30px;">
            <div class="row text-center">
                <div class="col-sm-12 mb-2 ">
                    <div class="form-group inputWithIcon">
                        <input type="text" class="form-control" name="FnameWeb" id="inputname" placeholder="ชื่อ" required pattern="^[ก-๏]+$">
                ...
                <div class="col-sm-12 mb-2 ">
                    <div class="form-group inputWithIcon">
                        <input type="text" class="form-control" name="LnameWeb" id="inputlastname" placeholder="นามสกุล" required pattern="^[ก-๏]+$">
                        <i class="fas fa-user"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="row text-center">
                <div class="col-sm-12 mb-2 ">
                    <div class="form-group inputWithIcon">
                        <input type="text" class="form-control" name="UsernameWeb" id="username" value!=username placeholder="ชื่อผู้ใช้" required pattern="^[a-zA-Z,0-9]+$">
                        <i class="fas fa-user"></i>
                    </div>
                </div>
                <div class="col-sm-12 mb-3">
                    <div class="form-group inputWithIcon">
                        <input type="password" class="form-control" name="PasswordWeb" id="password" placeholder="รหัสผ่าน" required>
