...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-info" id="tab">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <input class="form-control mr-sm-3" id="myInput" type="search" placeholder="Search"
                onchange="search(this.value)" aria-label="Search">
            <button class="btn btn-outline-light" type="button" name="button" OnClick="seach();">ค้นหา</button>
            <!-- <button class="btn btns my-sm-2" id="butseacrh" onchange="search(this.value)">ค้นหา</button> -->
            ...
            <ul class="navbar-nav text-uppercase" id="ml">
                ...
                <li class="nav-item dropleft">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="register.html">เพิ่มสมาชิก</a>
